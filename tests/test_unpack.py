                ...
                "children": [
                    {
                        ...
                        "filepath": None,
                        "extrpath": [b"multipart.eml", u"\u60e1\u610f\u8edf\u9ad4.doc".encode("utf-8"),],
                        "package": "doc",
                        "platform": "windows",
                        "selected": True,
                        "preview": True,
                    ...
                    },
                    {
                        ...
                        "filepath": None,
                        "extrpath": [b"multipart.eml", b"cuckoo.png",],
                        "package": None,
                        "platform": None,
                        "selected": False,
                        "preview": True,
...
def test_read1():
    ...
    assert len(f.read([b"efax_9057733019_pdf.zip", b"efax_9057733019_pdf.scr",])) == 377856


def test_read2():
    f = unpack(b"tests/files/msg_invoice.msg")
    assert len(f.read(b"oledata.mso")) == 234898
    assert len(f.read([b"oledata.mso", b"Firefox Setup Stub 43.0.1.exe",])) == 249336
